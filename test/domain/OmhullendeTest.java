...
public class OmhullendeTest {
    ...
    @Test
    public void getMaxX_moet_gelijk_zijn_aan_X_plus_de_breedte(){
        assertEquals(linkerBovenhoek.getX()+breedte,omhullende.getMaxX());
    }
    @Test
    public void getMinX_moet_gelijk_zijn_aan_X_Waarde(){
        assertEquals(linkerBovenhoek.getX(),omhullende.getMinX());
    }
    @Test
    public void getMaxY_moet_gelijk_zijn_aan_Y_plus_hoogte(){
        assertEquals(linkerBovenhoek.getY()+hoogte,omhullende.getMaxY());
    }
    @Test
    public void getMinY_moet_gelijk_zijn_aan_Y_waarde(){
        assertEquals(linkerBovenhoek.getY(),omhullende.getMinY());
    }
}